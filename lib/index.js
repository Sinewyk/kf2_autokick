...
const removePerks = typeof yargs_1.argv.removePerks !== 'undefined' ? yargs_1.argv.removePerks.split(',') : [];
...
const rolesToForbid = removePerks.reduce((acc, perkToRemove) => acc.concat(interfaces_1.PERKS[perkToRemove]), []);
